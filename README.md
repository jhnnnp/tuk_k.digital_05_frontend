...
TIBO는 React Native와 Expo를 기반으로 한 **객체 추적 기술을 활용한 지능형 홈캠 시스템**입니다. 기존 홈캠의 정적인 시야 한계를 극복하고, 움직임을 지속적으로 추적하여 능동적이고 안전한 모니터링 환경을 제공합니다.

## 🎯 프로젝트 목표

### 기존 홈캠의 한계 극복
- **정적 시야 의존**: 대상이 화면에서 벗어나면 추적 불가
- **즉각적 대응 부족**: 위험 상황에 대한 지연된 대응
- **수동적 모니터링**: 사용자의 지속적인 주의 필요

### TIBO의 혁신적 해결책
- **객체 추적 기술**: 움직임을 능동적으로 추적
- **실시간 위험 감지**: 일정 범위 벗어날 경우 즉시 알림
- **지능형 모니터링 시스템**: 자동화된 안전 감시

## 🚀 주요 기능

### 📱 모바일 앱 (React Native + Expo)
- **실시간 라이브 스트림** - 실시간 모니터링
- **지능형 객체 추적** - 움직임 지속적 추적
...
- **실시간 모니터링**: 24시간 지속적인 감시

### 🤖 지능형 기능
- **자동 추적**: 대상이 화면에서 벗어나도 추적 가능
- **실시간 알림**: 위험 상황 즉각 대응
- **스마트 녹화**: 상황별 자동 녹화
